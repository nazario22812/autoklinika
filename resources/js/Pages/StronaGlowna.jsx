    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#F1511A] to-[#FFAA01]">
            <div className='w-full bg-gray-200 mx-auto'>
                <div className="grid grid-cols-1 md:grid-cols-2 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-auto md:h-[450px] overflow-hidden relative gap-4 md:gap-0">
                    <div className="flex items-center justify-center h-64 md:h-auto">
                        <img 
                            className="w-full h-full rounded-xl shadow-md object-cover object-center"
                    ...
                    <div className="flex items-center justify-center py-8 md:py-0">
                        <div className="text-center px-4">
                            ...
                            <Link href="/booking" className="inline-block px-4 sm:px-6 py-3 bg-gray-900 text-white font-semibold rounded-md hover:bg-red-500 transition">
                                Zarezerwuj wizytę
                            </Link>
                        </div>
                    </div>
            ...
            <div className="w-full overflow-hidden relative py-8 md:py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-10 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-gray-200 p-4 sm:p-6 lg:p-8 flex flex-col items-center justify-center text-center rounded-xl shadow-sm transition hover:shadow-md">
                        ...
                        <Link href="/services" className="inline-block px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base bg-red-500 text-white font-semibold rounded-md hover:bg-gray-900 transition">
                            Odkryj nasze usługi
                        </Link>
                    </div>
                    ...
                    <div className="bg-gray-200 p-4 sm:p-6 lg:p-8 flex flex-col items-center justify-center text-center rounded-xl shadow-sm transition hover:shadow-md">
                        ...
                        <Link href="/check-order" className="inline-block px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base bg-red-500 text-white font-semibold rounded-md hover:bg-gray-900 transition">
                    ...
                    <div className="bg-gray-200 p-4 sm:p-6 lg:p-8 flex flex-col items-center justify-center text-center rounded-xl shadow-sm transition hover:shadow-md">
                        ...
                        <Link href="/faq" className="inline-block px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base bg-red-500 text-white font-semibold rounded-md hover:bg-gray-900 transition">
